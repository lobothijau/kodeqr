...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-background p-6 text-[#1b1b18] lg:justify-center lg:p-8"
    >
        <header
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span class="relative bg-white py-1">
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-background shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]"
                                >
                                    <span
